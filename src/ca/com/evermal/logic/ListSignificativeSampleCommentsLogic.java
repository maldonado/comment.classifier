...
public class ListSignificativeSampleCommentsLogic implements Logic{
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp)	throws Exception {
		...
		comment = new SignificativeSampleDao(connection).getSignificativeSampleCommentsToClassifyByReviewer(reviewerName);
